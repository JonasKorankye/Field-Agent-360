 ...
 */
public class RevenueCollection extends FragmentPages {

    AppCompatTextView collectorSelector;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View rootView = inflater.inflate(R.layout.revenue_collection, container, false);
        collectorSelector = (AppCompatTextView) rootView.findViewById(R.id.collectorSelector);
        collectorSelector.setOnClickListener(new View.OnClickListener() {
            @Override
                    ...
                    protected void onRequestComplete(ArrayList<RequestObject> requestObjects) {
                        ...
                        new RequestObjSelectorDialog() {
                            ...
                            public void onListItemSelected(RequestObject requestObject) {
                                ...
                                collectorSelector.setText(requestObject.getName());
                            }
                        }.fragmentInstanceDialogFragment(requestObjects, "Select Revenue Type").show(getFragmentManager(), "");
                    }
                }.getRequestObject(getContext(), Constants.UrlConstant.revenues, "Name");
            }
        });
        ...
        rootView.findViewById(R.id.pay).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (selectedOption == null) {
                    FunUtils.showMessage(getContext(), "Revenue Payment Type has not been selected");
                } else {
                    ...
                    if (customerId.length() != 0) {
                        if (amount.length() != 0) {
                            ...
                            if (amountValue > 0) {
                                ...
                                }.collectRevenue(getContext(), selectedOption, customerId, amountValue);
                            } else {
