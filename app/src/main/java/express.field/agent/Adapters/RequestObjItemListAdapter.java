 ...
 */
abstract public class RequestObjItemListAdapter extends RecyclerView.Adapter<ItemListHolder> {

    private Context mContext;

    ArrayList<RequestObject> requestObjects;

    public RequestObjItemListAdapter(Context context, ArrayList<RequestObject> requestObjects) {
        mContext = context;
    ...
    public void onBindViewHolder(ItemListHolder holder, final int position) {
        holder.itemName.setText(requestObjects.get(position).getName());
