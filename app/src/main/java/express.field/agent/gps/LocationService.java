...
public class LocationService extends Service implements
    ...
    private String trackAgentMovement;
    ...
    public void onCreate(){
        super.onCreate();
        trackAgentMovement = Constants.UrlConstant.agent_roaming_monitoring;
    ...
    protected void sendLocationDataToWebsite(Location location) {
        ...
        SharedPreferences sharedPreferences = this.getSharedPreferences("xyz.belvi.agent.system.gps.prefs", Context.MODE_PRIVATE);
        ...
        Toast.makeText(this,"CurrentLocation :  Lat::"+location.getLatitude()+"  Lng::"+location.getLongitude(),Toast.LENGTH_LONG).show();
        ...
        final String uploadWebsite = sharedPreferences.getString("trackAgentMovement", trackAgentMovement);
